...
class Compiler
{
    public function compile($pharFile, $namePhar, $dirLib, array $autoload)
    {
    ...
    protected function getStub($namePhar, array $autoload)
    {
        $require = '';
        foreach ($autoload as $file) {
            $require .= sprintf("require_once 'phar://%s/%s';\n", $namePhar, $file);
        }
